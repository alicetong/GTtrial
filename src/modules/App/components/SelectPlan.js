    ...
    return (
      <div>
        ...
        <PanelArea>
          <MainPanal>
            <div style={{ width: '100%' }}>
              <PanalHeaderText style={{ padding: '10px 0px 7px 18px' }}>Become a Premium Member</PanalHeaderText>
              <hr />
              <section style={{ padding: '5px 27px 33px 29px' }}>
                <PanalHeaderText>Membership type</PanalHeaderText>
                <PanalSubHeaderText>Explore and choose a plan that best helps your creative journey</PanalSubHeaderText>
                <Planarea>
                  <PlanForm>
                    <FormChoice>
                      <ChoiceBox>
          ...
          <SidePanal>
            <div style={{ width: '100%', position: 'relative' }}>
              <PanalHeaderText style={{ padding: '10px 0px 7px 18px' }}>Request Summary</PanalHeaderText>
              <div>
                <hr />
                <section style={{ padding: '5px 27px 33px 29px' }}>
                  <PanalSubHeaderText>Plan Type</PanalSubHeaderText>
                  <PanalSubHeaderText>Duration</PanalSubHeaderText>
                  <PanalSubHeaderText>Payment Information</PanalSubHeaderText>
                  <PanalSubHeaderText>Add Quota</PanalSubHeaderText>
                  <PanalSubHeaderText>yes</PanalSubHeaderText>
                </section>
              </div>
...
`;
const PanalHeaderText = styled.h3`
font-size: 16px;
color: #303030;
font-weight: 700;
margin: 5px 0px;
`;
const PanalSubHeaderText = styled.h4`
font-size: 14px;
color: #8c8c8c;
font-weight: 300;
margin: 5px 0px;
